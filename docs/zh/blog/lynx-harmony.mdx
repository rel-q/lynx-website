...
1. **[LynxResourceFetcher](/api/lynx-native-api/lynx-generic-resource-fetcher/fetch-resource.html#harmony)**：资源加载能力，开发者只需实现该协议，即可将 App 已有的资源加载能力对接给 Lynx，确保 Lynx 可以轻量和高效地融入现有的开发体系中。
...
在 "二维码" 选项点击 “复制链接” 按钮并粘贴到 Lynx Explorer 的 Card URL 输入框，然后点击 "Go"。
