...
Update your `oh-package.json5` to use the dev versions:

```json5 title="oh-package.json5" {2,5}
- "@lynx/lynx": "3.4.0",
+ "@lynx/lynx": "3.4.0-dev",

- "@lynx/lynx_devtool": "3.4.0",
+ "@lynx/lynx_devtool": "3.4.0-dev",
```

### Install Dependencies

Run `ohpm install` or click `Sync and Refresh Project` in DevEco to install dependencies and recompile.
