...
## [Lynx 3.5: Main Thread Script, Fetch API, HarmonyOS Capability Alignment](/blog/lynx-3-5)

_November 10th, 2025 by [Leron Liu](https://github.com/loongliu), representing [The Lynx Team](https://x.com/lynxjs_org)_

Lynx 3.5 is officially released! Continuing our stable bi-monthly schedule, this update brings enhancements to main thread scripting, upgrades to the Fetch API, and further aligns capabilities on the HarmonyOS platform.

## [Announcing Lynx for HarmonyOS](/blog/lynx-harmony)

_Sep 25th, 2025 by [Qiang Bai](https://github.com/rel-q)、[Wentao Shi](https://github.com/toretto-wt), representing [The Lynx Team](https://x.com/lynxjs_org)_
